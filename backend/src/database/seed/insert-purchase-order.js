...
async function insertPurchaseOrderData() {
  ...
  try {
    ...
    const purchaseOrders = [
      [1001, 1001, `PO-${Date.now()}-001`, '张三', 'ZHANG001', '采购部门', '电子工程', '研发项目A', '待下发', '1', 'SUP001', '上海供应商A', 1, '采购经理1'],
      [1002, 1002, `PO-${Date.now()}-002`, '李四', 'LI002', '技术部门', '机械工程', '研发项目B', '已确认', '1', 'SUP002', '北京供应商B', 2, '采购经理2'],
      [1003, 1003, `PO-${Date.now()}-003`, '王五', 'WANG003', '生产部门', '软件工程', '研发项目C', '已完成', '1', 'SUP003', '广州供应商C', 3, '采购经理3'],
      [1004, 1004, `PO-${Date.now()}-004`, '赵六', 'ZHAO004', '采购部门', '电子工程', '研发项目D', '待下发', '1', 'SUP004', '深圳供应商D', 4, '采购经理1'],
      [1005, 1005, `PO-${Date.now()}-005`, '孙七', 'SUN005', '技术部门', '机械工程', '研发项目E', '已确认', '1', 'SUP005', '杭州供应商E', 5, '采购经理2'],
      [1006, 1006, `PO-${Date.now()}-006`, '周八', 'ZHOU006', '生产部门', '软件工程', '研发项目F', '已完成', '1', 'SUP006', '苏州供应商F', 6, '采购经理3'],
      [1007, 1007, `PO-${Date.now()}-007`, '吴九', 'WU007', '采购部门', '电子工程', '研发项目G', '待下发', '1', 'SUP007', '南京供应商G', 7, '采购经理1'],
      [1008, 1008, `PO-${Date.now()}-008`, '郑十', 'ZHENG008', '技术部门', '机械工程', '研发项目H', '已确认', '1', 'SUP008', '武汉供应商H', 8, '采购经理2'],
      [1009, 1009, `PO-${Date.now()}-009`, '王一一', 'WANG009', '生产部门', '软件工程', '研发项目I', '已完成', '1', 'SUP009', '成都供应商I', 9, '采购经理3'],
      [1010, 1010, `PO-${Date.now()}-010`, '李二二', 'LI010', '采购部门', '电子工程', '研发项目J', '待下发', '1', 'SUP010', '西安供应商J', 10, '采购经理1']
    ];
